...
(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: '/img/slideshow/loader.gif',
                     start_at_index: 0,
  ...
  function VerticalSlideAnimation(img_container, direction, desc) {
    ...
    if(direction == 'left') {
      ...
      img_container.css('bottom', this.image_wrapper_height +'px');
    } else {
      old_image_top = this.image_wrapper_height +'px';
      img_container.css('bottom', '-'+ this.image_wrapper_height +'px');
    }
    ...
    return {old_image: {bottom: old_image_top},
            new_image: {bottom: current_top}};
  };
